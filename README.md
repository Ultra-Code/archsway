...
- On the freshly installed system
 - use ttf-croscore(Cousine:monospace,Tinos:serif,Arimo:sans-serif) or noto-fonts or ttf-ibm-plex as default system font
 - cantarell for sans-serif(it's automatically installed by gtk),
 - ttf-jetbrains-mono or ttc-iosevka for monospace,
 - ttf-nerd-fonts-symbols-1000-em-mono for nerd font symbols and noto-font-emoji for emoji
